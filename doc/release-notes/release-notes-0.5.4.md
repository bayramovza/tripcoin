Tripcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/tripcoin/files/Tripcoin/tripcoin-0.5.4/
...
http://gitorious.org/tripcoin/tripcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Tripcoin-Qt notifications under Growl 1.3.
Increase required age of Tripcoin-Qt's "not up to date" status from 30 to 90 minutes.

Tripcoin Core version 0.9.4 is now available from:

  https://tripcoin.org/bin/0.9.4/
...
this update is incompatible with the Tripcoin system and could lead to consensus
forks.

Tripcoin Core released binaries from https://tripcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~tripcoin/+archive/ubuntu/tripcoin
- A third-party or self-compiled Tripcoin Core

upgrade to Tripcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

Tripcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/tripcoin/files/Tripcoin/tripcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Tripcoin
...
New/changed settings (command-line or tripcoin.conf file)
--------------------------------------------------------

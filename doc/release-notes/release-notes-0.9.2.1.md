Tripcoin Core version 0.9.2.1 is now available from:

  https://tripcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TPC to 0.01 TPC
...
- Fix "Start tripcoin on system login"

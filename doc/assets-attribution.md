The following is a list of assets used in the tripcoin source and their proper attribution.
...
* Tripcoin Icon: (based on the original tripcoin logo from Bitboy)
* Some icons are based on Stephan Hutchings Typicons
* License: MIT

### Assets Used
    src/qt/res/icons/about.png, src/qt/res/icons/about_qt.png,
    src/qt/res/icons/tripcoin.icns, src/qt/res/icons/tripcoin.ico,
    src/qt/res/icons/tripcoin.png, src/qt/res/icons/clock*.png,
    ...
    src/qt/res/src/verify.svg, src/qt/res/src/tripcoin.svg,

...
#ifndef TRIPCOIN_RPCPROTOCOL_H
#define TRIPCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Tripcoin is not connected

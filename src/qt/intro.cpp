...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(SingleColorIcon(":icons/tripcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Tripcoin Core"),
     ...
     * override -datadir in the tripcoin.conf file in the default data directory
     * (to be consistent with tripcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())

    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("Tripcoin Core");
    QString versionText     = QString("Version %1").arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Tripcoin Core developers"));
    ...
    // draw the tripcoin icon, expected size of PNG: 1024x1024

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Tripcoin Core tripcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tripcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tripcoin transaction") + "\n" +
              "  tripcoin-tx [options] -create [commands]   " + _("Create hex-encoded tripcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tripcoin transaction

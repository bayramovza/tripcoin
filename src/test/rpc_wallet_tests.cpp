...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CTripcoinAddress demoAddress = CTripcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CTripcoinAddress setaccountDemoAddress = CTripcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CTripcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CTripcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}

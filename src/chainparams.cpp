...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("tripcoin.petertodd.org", "testnet-seed.tripcoin.petertodd.org"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "testnet-seed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("tripcoin.schildbach.de", "testnet-seed.tripcoin.schildbach.de"));
